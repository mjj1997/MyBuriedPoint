...
// configuration step. It creates a namespace called `MyBuriedPoint`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MyBuriedPoint::cmake::project_name, MyBuriedPoint::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MyBuriedPoint::cmake::project_version);
      return EXIT_SUCCESS;
    }
